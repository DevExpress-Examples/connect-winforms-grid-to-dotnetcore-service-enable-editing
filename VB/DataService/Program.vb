...
Friend Module Program
    ...
    Sub Main(args As String())
        ...
        app.MapGet("/data/OrderItem/{id}", Async Function(dbContext As DataServiceDbContext, id As Integer)
                                               Dim orderItem As OrderItem = Await dbContext.OrderItems.FindAsync(id)
        ...
        app.MapPost("/data/OrderItem", Async Function(dbContext As DataServiceDbContext, orderItem As OrderItem)
                                           dbContext.OrderItems.Add(orderItem)
                                           Await dbContext.SaveChangesAsync()
                                           Return Results.Created($"/data/OrderItem/{orderItem.Id}", orderItem)
                                       End Function)

        app.MapPut("/data/OrderItem/{id}", Async Function(dbContext As DataServiceDbContext, id As Integer, orderItem As OrderItem)
                                               If id <> orderItem.Id Then
        ...
        app.MapDelete("/data/OrderItem/{id}", Async Function(dbContext As DataServiceDbContext, id As Integer)
                                                  Dim orderItem As OrderItem = Await dbContext.OrderItems.FindAsync(id)
