...
#Region "Windows Form Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            ' gridControl
            ' 
            Me.gridControl.DataSource = Me.virtualServerModeSource
            ...
            Me.gridView1.DoubleClick += AddressOf gridView1_DoubleClick
            ' 
            ' colId
            ' 
            ...
            Me.barManager.Items.AddRange(New DevExpress.XtraBars.BarItem() {Me.addItemButton, Me.deleteItemButton})
            ...
            Me.addItemButton.ItemClick += AddressOf addItemButton_ItemClick
            ' 
            ' barDockControlTop
            ' 
            ...
            Me.deleteItemButton.ItemClick += AddressOf deleteItemButton_ItemClick
            ' 
            ' MainForm
            ' 
